...
const topReviews = [
  {
    ...
    quote:
      "This platform revolutionized our workflow. The efficiency gains are remarkable, and our team productivity has soared!",
    name: "Alex Johnson",
  ...
  },
  {
    logo: "/placeholder.svg?height=40&width=120",
    quote:
      "The intuitive interface and powerful features have made our data management a breeze. It's a game-changer for our analytics team.",
    name: "Samantha Lee",
    role: "Data Scientist",
  },
  {
    logo: "/placeholder.svg?height=40&width=120",
    quote:
      "Customer support is unparalleled. Any issues we've had were resolved quickly, allowing us to focus on our core business.",
    name: "Michael Chen",
    role: "IT Manager",
  },
  {
    logo: "/placeholder.svg?height=40&width=120",
    quote:
      "The customization options are extensive. We've been able to tailor the platform to fit our unique business needs perfectly.",
    name: "Rachel Patel",
    role: "Product Owner",
  },
  {
    logo: "/placeholder.svg?height=40&width=120",
    quote:
      "Implementing this solution has significantly reduced our operational costs. The ROI has exceeded our expectations.",
  ...
  },
  {
    logo: "/placeholder.svg?height=40&width=120",
    quote:
      "The analytics and reporting features have given us invaluable insights into our business performance. Highly recommended!",
    name: "Emma Thompson",
  ...
  return (
    <Fragment>
      ...
      <style jsx>{`
        ...
        .testimonial-track {
          display: flex;
          animation: ${direction === "left" ? "slideleft" : "slideright"} 60s
            linear infinite;
